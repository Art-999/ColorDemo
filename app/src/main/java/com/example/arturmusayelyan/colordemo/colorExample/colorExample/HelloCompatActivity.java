package com.example.arturmusayelyan.colordemo.colorExample.colorExample;
...
import com.example.arturmusayelyan.colordemo.R;
...
public class HelloCompatActivity extends AppCompatActivity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_hello_compat);
